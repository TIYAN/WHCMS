...
CREATE TABLE IF NOT EXISTS `tblaffiliateswithdrawals` (  `id` int(10) NOT NULL auto_increment,  `affiliateid` int(10) NOT NULL,  `date` date NOT NULL,  `amount` decimal(10,2) NOT NULL,  PRIMARY KEY  (`id`),  KEY `affiliateid` (`affiliateid`)) ;
ALTER TABLE `tblservers` ADD `hostname` TEXT NOT NULL AFTER `ipaddress` ;
UPDATE tblconfiguration SET value='3.7.0' WHERE setting='Version';