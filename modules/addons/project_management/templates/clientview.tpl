...
{include file="$template/pageheader.tpl" title=$_lang.projectdetails}
...
{include file="$template/subheader.tpl" title=$_lang.associatedtickets}
...
{include file="$template/subheader.tpl" title=$_lang.timetracking}
...
{include file="$template/subheader.tpl" title=$_lang.fileuploads}
...
{include file="$template/subheader.tpl" title=$_lang.tasks}
