...
/*
//----------------------------------------------------------
//   TPPW Registrar Module for WHMCS
//   Version: 2.4c
...
abstract class TPPW_API
{
    ...
    protected function TPPW_API($script, $params)
    {
...
class TPPW_AuthAPI extends TPPW_API
{
    ...
    function TPPW_AuthAPI($params)
    {
        parent::TPPW_API('auth.pl', $params);
    }
...
{
	static $domainWhois = false;

    function TPPW_QueryAPI($params)
    {
        parent::TPPW_API('query.pl', $params);
    }
    ...
    function domainSync($domains = null)
    {
    ...
    function domainPassword($domains)
    {
	...
	function orderStatus($workflow = true)
	{
...
{
    function TPPW_ResourceAPI($params)
    {
        parent::TPPW_API('resource.pl', $params);
    }
    ...
    function domainUnSuspendProduct()
    {
...
class TPPW_OrderAPI extends TPPW_API
{
    ...
    function TPPW_OrderAPI($params)
    {
        parent::TPPW_API('order.pl', $params);
    }
    ...
    private function getEligibilityDetails()
    {
        ...
        if($eligibilityForm)
        {
            ...
            else if(strpos($this->getTLD(), "asia") !== false) 
            {
...
class TPPW_APIResult
{
    ...
    function TPPW_APIResult($response)
    {
...
class TPPW_APIUtils
{
    ...
    static $BRAND_NAME = 'TPP Wholesale';

    static $MODULE_NAME = 'tppwregistrar';

    static $API_IP = '114.141.204.99';
	
	static $API_HOST = 'theconsole.tppwholesale.com.au';
	
	static $API_PATH = '/api/';

    static $URL_SUPPORT = 'http://www.tppwholesale.com.au/support/category/getting-started/whmcs';

    static $URL_SIGNUP = 'http://www.tppwholesale.com.au/sign-up.php';
	...
	static $CHECK_PERIOD_BEFORE_XFER = array 
	(
		'com.au',
		'net.au',
		'org.au',
    ...
    static $TRANSFORM_CONTACT_FIELDS = array
    (
    ...
    static $ASIA_IDENTITY_FORMS = array
    (
        'passport' => 'passport',
	...
	static function getWorkflowID($domainID) {
		$q = mysql_query("select value from tbldomainsadditionalfields where domainid = '$domainID' and name = 'TPPOrderID' LIMIT 0,1;");
	...
	static function setWorkflowID($domainID, $wfID) {
		if(TPPW_APIUtils::getWorkflowID($domainID) === false) {
			return mysql_query("insert into tbldomainsadditionalfields values ('NULL', '$domainID', 'TPPOrderID', '$wfID');");
		}
		else {
			return mysql_query("update tbldomainsadditionalfields set value = '$wfID' where domainid = '$domainID' and name = 'TPPOrderID';");
		}
    }
}
...
function tppwregistrar_getConfigArray()
{
    ...
    (
        ...
        (
            'Type' => 'yesno',
            'Description' => 'Tick this box to log API calls to WHMCS\' "Module Log" section. (Version: '. TPPW_APIUtils::$API_COMMON_PARAMS['Version'] . ')'
        ),

        '' => array('Description' => '<b>Need Help?</b> For assistance configuring WHMCS at TPP Wholesale, please see this <a target="_blank" href="'.TPPW_APIUtils::$URL_SUPPORT.'">support article</a>.'),
    );
...
function tppwregistrar_TransferSync($params)
{
        ...
        else if($results->getModuleErrorCode() === 311)
        {
