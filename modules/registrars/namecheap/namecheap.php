...
function namecheap_RegisterDomain($params)
{
    ...
    try
    {
        $registrant = array(
            ...
            'RegistrantOrganizationName' => $params['admincompanyname'],
            'RegistrantAddress1'         => $params['adminaddress1'],
            'RegistrantAddress2'         => $params['adminaddress2'],
            'RegistrantCity'             => $params['admincity'],
            'RegistrantStateProvince'    => $params['adminstate'],
        ...
        foreach ($registrant as $k => $v) {
            ...
            $tech[str_replace("Registrant", "Tech", $k)] = $v;
            $aux[str_replace("Registrant", "AuxBilling", $k)] = $v;
        }
